...
def parse_args():
    ...
    parser.add_argument('--eval_epochs', type=int, default=20, help='How often (in epochs) to evaluate model')
    parser.add_argument('--save_epochs', type=int, default=20, help='How often (in epochs) to save model')
